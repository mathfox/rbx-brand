 ...
 * ```
 */
export declare function identity<B extends AnyBrand>(underlying: BaseOf<B>): B;
/**
 * Asserts that a value is the type `Output`.
 */
export type AssertionFunction<Input, Output extends Input> = (value: Input) => asserts value is Output;
/**
 ...
 * ```
 */
export declare function make<B extends AnyBrand>(validator?: AssertionFunction<BaseOf<B>, B>): Brander<B>;
